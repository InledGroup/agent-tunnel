            ...
            conn.on('ready', () => {
                ...
                conn.exec(setupCmd, (err2, stream2) => {
                    const finalizeSsh = () => {
                        ...
                        const testCmd = `ssh ${compatOpts} -i "${sshKeyPath}" ${config.user}@${config.host} "echo 'success'"`;
                        ...
                        exec(testCmd, (testErr, testStdout) => {
                            ...
                            exec(`mutagen sync terminate "${validSessionName}"`, () => {
                                const mutagenEnv = { ...process.env, MUTAGEN_SSH_PATH: `ssh ${compatOpts} -i "${sshKeyPath}"` };
